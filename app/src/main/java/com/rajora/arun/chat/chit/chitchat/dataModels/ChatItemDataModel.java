...
public class ChatItemDataModel {
    ...
    public ChatItemDataModel(String content, long g_timestamp, String id, boolean is_bot, String receiver, String sender, long timestamp, String type) {
