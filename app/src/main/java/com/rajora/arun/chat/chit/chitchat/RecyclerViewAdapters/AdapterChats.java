...
import com.rajora.arun.chat.chit.chitchat.RecyclerViewAdapters.AdapterChats.VH;
...
public class AdapterChats extends CursorRecyclerViewAdapter<VH> {
	...
	public AdapterChats(Context context, Fragment fragment, String sender_no, Cursor cursor, String idColumn) {
	...
	public void onBindViewHolder(VH holderItem, Cursor cursor) {
		...
		switch (item.message_type) {
			case "text":
				handleText((VH_TEXT) holderItem, item);
				break;
			case "image":
				handleImage((VH_IMAGE) holderItem, item);
				break;
			case "video":
				handleVideo((VH_VIDEO) holderItem, item);
				break;
			case "file":
				handleFile((VH_FILE) holderItem, item);
				break;
			case "contact":
				handleContact((VH_CONTACT) holderItem, item);
				break;
			case "location":
				handleLocation((VH_LOCATION) holderItem, item);
				break;
		}
	}

	private void handleText(VH_TEXT holder, ChatItemDataModel item) {
		holder.itemView.setContentDescription(String.format(mContext.getString(R.string.handle_text_str),
	...
	private void handleImage(final VH_IMAGE holder, final ChatItemDataModel item) {
		try {
			...
			if (item.upload_status == null) {
				...
				holder.mButton.setImageResource(R.drawable.download_icon);
				...
				switch (item.upload_status) {
					...
					case "download_failed":
						holder.mButton.setImageResource(R.drawable.ic_error_black_24dp);
						holder.mButton.setVisibility(View.VISIBLE);
						holder.mProgress.setVisibility(View.GONE);
						break;
				}
			...
			if (item.upload_status == null) {
				...
				switch (item.upload_status) {
					...
					case "uploaded":
						...
						holder.mProgress.setVisibility(View.GONE);
						holder.mButton.setImageResource(R.drawable.ic_play_circle_filled_black_24dp);
						holder.mButton.setVisibility(View.VISIBLE);
						break;
					case "downloading":
						holder.mButton.setVisibility(View.GONE);
		...
		try {
			...
			if (item.upload_status == null) {
				...
				switch (item.upload_status) {
					...
					case "uploaded":
						holder.mProgress.setVisibility(View.GONE);
						holder.mButton.setImageResource(R.drawable.ic_open_in_new_black_24dp);
						holder.mButton.setVisibility(View.VISIBLE);
						break;
					case "downloading":
						holder.mButton.setVisibility(View.GONE);
		...
		try {
			...
			holder.itemView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View view) {
					...
					if (intent.resolveActivity(mContext.getPackageManager()) != null) {
						mContext.startActivity(Intent.createChooser(intent, mContext.getString(R.string.select_an_app_msg)));
					} else {
	...
	public VH onCreateViewHolder(ViewGroup parent, int viewType) {
		switch (viewType) {
			case 1:
				return new VH_TEXT(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_text, parent, false));
			case 2:
				return new VH_TEXT(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_text, parent, false));
			case 3:
				return new VH_IMAGE(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_image, parent, false));
			case 4:
				return new VH_IMAGE(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_image, parent, false));
			case 5:
				return new VH_VIDEO(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_video, parent, false));
			case 6:
				return new VH_VIDEO(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_video, parent, false));
			case 7:
				return new VH_FILE(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_file, parent, false));
			case 8:
				return new VH_FILE(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_file, parent, false));
			case 9:
				return new VH_CONTACT(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_contact, parent, false));
			case 10:
				return new VH_CONTACT(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_contact, parent, false));
			case 11:
				return new VH_LOCATION(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_send_location, parent, false));
			case 12:
				return new VH_LOCATION(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_chat_receive_location, parent, false));
			default:
				return null;
		}
	}
