...
import com.rajora.arun.chat.chit.chitchatdevelopers.recyclerview_adapters.AdapterBotItem.VH;
import com.rajora.arun.chat.chit.chitchatdevelopers.utils.ImageUtils;


public class AdapterBotItem extends CursorRecyclerViewAdapter<VH> {

	private onItemClickListener mItemClickListener;
	private Context mContext;

	public AdapterBotItem(Context context, onItemClickListener listener, Cursor cursor, String idColumn) {
