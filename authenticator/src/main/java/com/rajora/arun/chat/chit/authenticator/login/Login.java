    ...
    class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position)
        {
            if (android.os.Build.VERSION.SDK_INT >= 23) {
                switch (position){
                    case 0:return WelcomeSplashFragment.newInstance();
                    case 1:return PermissionsSplashFragment.newInstance();
                    case 2: return LoginSplashFragment.newInstance();
                }
            }
            else{
                switch (position){
                    case 0:return WelcomeSplashFragment.newInstance();
                    case 1: return LoginSplashFragment.newInstance();
                }
            }
            return null;
        }
